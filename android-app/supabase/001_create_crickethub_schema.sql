/*
  CricketHub Supabase PostgreSQL schema
  Run in Supabase Dashboard -> SQL Editor.

  This creates a private-ish application schema named "app".
  Use this database from your backend API. Do not put database credentials in the APK.
*/
